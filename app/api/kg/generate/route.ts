...
export async function POST(request: Request) {
      ...
      return NextResponse.json(
        {
          ...
          error: {
            ...
            message: "Backend only supports text_path JSON extraction; file uploads are unavailable.",
          },
        },
        { status: 400 }
      );
  ...
  const parsed = parseBackendPayload(backendResponse.headers.get("content-type"), rawBody);
